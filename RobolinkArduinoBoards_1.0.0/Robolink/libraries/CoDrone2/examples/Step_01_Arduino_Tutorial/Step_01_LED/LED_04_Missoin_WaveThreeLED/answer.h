...
void setup()
{
  ...
  pinMode(4, OUTPUT);      // 4번 핀을 출력으로 설정 (사용 가능한 핀 번호 : 4, 5, 6, 7)
  pinMode(5, OUTPUT);      // 5번 핀을 출력으로 설정 (사용 가능한 핀 번호 : 4, 5, 6, 7)
  pinMode(5, OUTPUT);      // 6번 핀을 출력으로 설정 (사용 가능한 핀 번호 : 4, 5, 6, 7)
}
